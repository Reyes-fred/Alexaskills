...
var questions = [
    ...
    { value : "What is the angle between the hour hand and minute hand in an analog clock?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "How do you detect whether or not a word is a palindrome?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "Here's a string with numbers from 1-250, in random order, but it's missing one number. How will you find the missing number?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "What is your favorite programming language?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "How would you implement bubble sort?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "How would you implement selection sort?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "How would you implement insertion sort?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "How would you implement merge sort?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "How would you implement quick sort?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "You have two very large numbers that cannot be stored in any available datatypes. How would you multiply them?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "How will you implement a dictionary?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "Given a matrix which is spirally sorted. Remove an element and insert another element, maintaining the sorted order.", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "How would you find if there is a cycle in a directed graph?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
    { value : "How would you implement a method that converts a binary search tree into a sorted double-linked list, without creating any new nodes?", tags : ["technical", "amazon", "google", "microsoft", "intel", "bosch"] },
...
var CARD_TITLE ="Interview Training"; // Be sure to change this for your skill.
